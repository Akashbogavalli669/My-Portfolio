...
![Theme](https://img.shields.io/badge/Theme-Dark/Light-blueviolet)
...
- **Interactive Elements:**
  - **Typewriter Effect:** Cycling professional roles.
  - **Spotlight Cards:** Hover-sensitive radial glow on project and certification cards.
  - **Scroll Reveals:** Intersection Observer API for smooth "reveal-up" animations.
...
├── Portfolio_Image.png # Profile picture
